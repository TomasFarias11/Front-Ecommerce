...
{/* esto es lo que funciona */}
                <div className=" card col-lg-8">
                    <div className="container-sm bg-image hover-overlay ripple" data-mdb-ripple-color="light" style={{ padding: 20 } } >
                        ...
                        <div className="row row-cols-0 row-cols-md-3 g-5 mask" Style="background-color: #EAEAEA"    >
                            {
                                products.map(e =>
                                    <div className="col" key={e.id}>
                                        <div className="card" >
                                            <img src="https://i.postimg.cc/SK600jXG/OIP.jpg" className="card-img-top img-fluid" alt={e.image} style={{padding:"30 0"}} />
