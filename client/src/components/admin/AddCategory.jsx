  ...
  return(<div className="row">
    <div className="col-lg-3">
        ...
        <div className="badge fs-3 bg-dark text-wrap" style={{ width: "20rem" }}>
          ...
          <Link to="/admin/Category">
            <button type="button" className="btn btn-outline-info btn-lg">Lista de Categorías</button>
          </Link>
        </div>
    </div>
    ...
    <div className="container mt-4 mb-5 mx-3">
      ...
      <div className="card-header d-flex align-items-center">
          ...
          <label for="exampleInputName">Nombre de la nueva Categoría</label>
        ...
        <button className="btn btn-success btn-lg d-flex align-items-center float-right" type="submit" style={{marginTop:0, marginBottom:10}}>Añadir Categoría</button>
    </div>
    </div>
    </div>
    </div>
